...
{     data = React.createRef();
      ...
      render(){
        ...
        <div   style={{marginBottom: '19px', marginTop: '6px'}}>
          <div className="row">
            <div className="col d-flex justify-content-center align-items-center" style={{width: '80%', minWidth: '80%', maxWidth: '80%'}}><label className="form-label" style={{fontWeight: 'bold', marginLeft: '11px', marginTop: '5px', fontSize: '23px', color: 'rgb(63,70,78)'}}>{1}:&nbsp;&nbsp;</label><textarea ref = {this.data} style={{width: '95%', height: '46px', minWidth: '50%', fontSize: '22px', paddingLeft: '11px', paddingTop: '5px'}} /></div>
          ...
          <div className="card" style={{borderRadius: '8px'}}>
            <div  className="card-body" style={{paddingLeft: '54px', paddingTop: '20px', paddingBottom: '20px'}}>
              ...
              <div className="d-flex d-xxl-flex justify-content-center justify-content-xxl-center" style={{paddingLeft: '13px', marginTop: '22px', marginRight: '70px'}}>
                  <button   className="btn" type="button" onClick={this.addAnswer}   style={{background: '#00a210', fontWeight: 'bold', color: 'rgb(255,255,255)'}} >Add answer</button>
                  <button   className="btn" type="button" onClick={this.removeAnswer}   style={{background: '#c90101', fontWeight: 'bold', color: 'rgb(255,255,255)'}} >Remove answer</button>
              </div>
...
class Creat_exam extends React.Component {
  ...
  addQuestion = () => {
    this.count += 1;
    let a = new Question(this.count);
    this.setState({
      questions: [...this.state.questions, a] 
    })  
  }
  removeQuestion = () => {
    this.count -= 1;
                      ...
                      <main className="page landing-page" style={{paddingTop: '0px'}}>
                        <section className="shadow-lg" style={{background: '#3c65c4', paddingBottom: '62px'}}>
                          ...
                          <div className="container">
                          {
                            ...
                            <button type="button" onClick={this.removeQuestion}   className="btn"  style={{background: '#c90101', fontWeight: 'bold', color: 'rgb(255,255,255)', width: '100%', height: '51px'}} >Remove question</button> 
                             <button onClick={this.addQuestion}  className="btn" type="button" style={{background: '#00a210', fontWeight: 'bold', color: 'rgb(255,255,255)', width: '100%', height: '51px'}}>Add question</button></div>
                            <div className="text-center" style={{paddingTop: '67px', paddingBottom: '160px'}}><button className="btn" type="button" onClick={this.submit} style={{background: '#ffffff', height: '60px', width: '170.025px', fontWeight: 'bold', fontSize: '16px'}}>Create Exam</button></div>
                          </div>
